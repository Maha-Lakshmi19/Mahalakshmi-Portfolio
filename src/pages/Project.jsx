...
const projects = [
  {
    ...
    github: "#", // replace later with GitHub link
    image: portfolioImg,
  },
  {
    title: "Form Validation Project",
    description:
      "Implemented real-time validation for forms with JavaScript and Bootstrap.",
  ...
  },
  {
    ...
    description:
      "Designed a modern static landing page with responsive UI and cross-browser support.",
